...
def controlled_vocabularies():
    ...
    vocab_adapter.VOCAB_CACHE[PHYSICALSPECIMEN_URI] = material_sample_type_vocabulary._uijson_dict
    vocabulary_mapper.SPECIMEN_TYPE = material_sample_type_vocabulary
